    ...
    <div className="query-container card">
      <div className="query-header">
        ...
        {(state?.current_query || isTranscribing) && (
          <span className="badge" style={{ background: 'var(--accent-cyan-dim)', color: 'var(--accent-cyan)', border: '1px solid rgba(0,229,255,0.2)' }}>
      ...
      <div className="dialogue-display" ref={listRef}>
        {history.length === 0 ? (
          <div className="empty-state">
            ...
            <p style={{ marginTop: 4, fontSize: '0.8rem' }}>Press the microphone button below to ask WalkSense.</p>
          </div>
        ) : (
          history.map((entry, i) => (
